...
void GuiOverridesMenu::draw() {
    ...
    Gui::drawTextAligned(font20, Gui::g_framebuffer_width / 2, 150, currTheme.textColor, "为每个应用添加按键覆盖选项。\n 在打开该应用时按住该按键组合将用 HBmenu 覆盖它。", ALIGNED_CENTER);
        ...
        case OverrideButtonType::Add_New:
            ...
            inputAction = [&](u64 kdown, bool *isActivated) {
                if (kdown & HidNpadButton_A) {
                    ...
                    (new ListSelector("为以下对象添加新的按键覆盖:", "\uE0E1 返回     \uE0E0 确定", configNames, 0))
